...
// 		<!-- conteúdo -->
// 		<div class="description">
// 			<p>xxxxxxxxxxxxx</p><span class="end"> </span>
// 		</div>
// 	</div>
// </div>
//     `
...
// 			</div>
// 		</div>
// 		<div class="content-item-body"><iframe src="https://www.youtube.com/embed/vvvvvvvvvvv" allowfullscreen="allowfullscreen"></iframe>
// 			<div style="position:relative">
// 				<div style="position: absolute; top: 5px">
// 				<a class="inline_disabled" title="Versão sem Libras" href="xxxxxxxxxxxxx" target="_blank">Versão sem Libras</a><!-- link do youtube -->
// 				</div>
//
// 				<div class="btn-bar">
// 					<a class="btn btn-padrao icon-audio" href="https://drive.google.com/uc?export=download&amp;id=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" target="_blank">Audiodescrição</a>
// 					<a class="btn btn-padrao icon-educators" href="yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy" target="_blank">Slides de  Apoio</a>
// 					<a class="btn btn-padrao icon-cloud-download" href="https://drive.google.com/uc?export=download&amp;id=zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz" target="_blank">Download do Vídeo</a>
// 				</div>
// 			</div>
// 		</div>
//
...
// ]
//
// export const classicoJson = JSON.stringify(classico)
//
// console.log(classicoJson);
